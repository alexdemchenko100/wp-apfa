...
if ( ! function_exists( 'afpa_theme_support' ) ) :
	/**
	 * Add theme supports
	 */
	function afpa_theme_support() {
		// Add language support: @link {https://codex.wordpress.org/Multilingual_WordPress}
		load_theme_textdomain( 'afpa', get_template_directory() . '/languages' );
	...
	add_action( 'after_setup_theme', 'afpa_theme_support' );
endif;
