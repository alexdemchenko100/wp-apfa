...
if ( ! class_exists( 'Afpa_Protocol_Relative_Theme_Assets' ) ) :

	/**
	 * Afpa_Protocol_Relative_Theme_Assets class
	 */
	class Afpa_Protocol_Relative_Theme_Assets {
		/**
	...
	$afpa_protocol_relative_theme_assets = new Afpa_Protocol_Relative_Theme_Assets();
endif;
