<?php
/**
 * Various functions required for afpa-bootstrap to work properly
 *
 * @package Afpa
 */
...
/**
 * afpa_navwalker class
 * Menu navigation walker
 * Class Name: afpa_navwalker
 * GitHub URI: https://github.com/twittem/wp-afpa-navwalker
 * Description: A custom WordPress nav walker class to implement the afpa 3 navigation style in a custom theme using the WordPress built in menu manager.
 */
class Afpa_Navwalker extends Walker_Nav_Menu {
	/**
	 * Walker::start_lvl()
	 *
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) === 0 && $depth === 1 ) {
			...
			$item_output .= '</span>';
			$item_output .= ( $args->has_children ) ? '<span class="caret"><svg width="8" height="5" viewBox="0 0 8 5" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 0.5L4 3.5L7 0.5" stroke="#9D9FA2"/></svg></span></a><span class="caret"><svg width="8" height="5" viewBox="0 0 8 5" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 0.5L4 3.5L7 0.5" stroke="#9D9FA2"/></svg></span>' : '</a>';
...
/**
 * Pagination
 * Custom pagination with afpa .pagination class
 * source: http://www.ordinarycoder.com/paginate_links-class-ul-li-afpa/
 *
 * @param boolean $echo echo
 * @return string
 */
function afpa_pagination( $echo = true ) {
	global $wp_query;
 ...
 * afpa Comments Tree
 */
if ( ! class_exists( 'afpa_Comments' ) ) :
	/**
	 * Undocumented class
	 */
	class Afpa_Comments extends Walker_Comment {
		/**
		 * tree_type
		 *
